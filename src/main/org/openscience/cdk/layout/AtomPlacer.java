            ...
            if (!atom.getFlag(CDKConstants.ISINRING))
            {
                ...
                for (int g = 0; g < bonds.size(); g++)
                {
                            ...
                            !nextAtom.getFlag(CDKConstants.ISPLACED))
                    {
                        ...
                        logger.debug("Old path " + (atomNr + 1) + " looks like: " + listNumbers(ac, pathes[atomNr]));
                        logger.debug("Copied path " + (nextAtomNr + 1) + " looks like: " + listNumbers(ac, pathes[nextAtomNr]));
                        ...
                        logger.debug("New path " + (nextAtomNr + 1) + " looks like: " + listNumbers(ac, pathes[nextAtomNr]));
